...
//    const val THEME_MODE_SYSTEM = 2
    ...
    const val FLAG_SET_HOME_APP_1 = 0
    const val FLAG_SET_HOME_APP_2 = 1
    const val FLAG_SET_HOME_APP_3 = 2
    const val FLAG_SET_HOME_APP_4 = 3
    const val FLAG_SET_HOME_APP_5 = 4
    const val FLAG_SET_HOME_APP_6 = 5
    const val FLAG_SET_HOME_APP_7 = 6
    const val FLAG_SET_HOME_APP_8 = 7
